...
- Each `step()` returns additional info fields such as `base_height`, `is_healthy`, `ctrl_cost`, `contact_cost`, base roll/pitch, and low-speed penalty terms (penalty weight is 0.0 by default).
